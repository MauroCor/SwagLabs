...
class ApiTasks:
    ...
    @staticmethod
    def body_constructor(api, body=None, *child_key, **kwargs):
        """
        Build request body.
        :param api: api folder in body folder.
        :param body: json file in api folder.
        :param child_key: child key to be edited in json.
        :param kwargs: key and value to be edited in json.
        :return: body type str.
        """
        if "{" not in api:
            body = json.load(
